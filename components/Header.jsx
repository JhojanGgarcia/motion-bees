...
const Header = () => {
  return (
    <header className="flex z-50 backdrop-blur-xl overflow-hidden rounded-b-3xl items-center justify-center  h-16 border-b border-white/5 fixed top-0 w-full">
      <span className="absolute left-12 w-full inset-x-12 bottom-0 h-px dark:bg-gradient-to-r to-black/0 via-[#5b5fa7]/20 from-black/0" />
      ...
      <span className="w-[206px] blur-3xl h-[206px] bg-[#5b5fa7] rounded-full absolute left-[calc(40%-0px)] -top-60" />
      <span className="w-[206px] blur-3xl h-[206px] bg-[#5b5fa7] rounded-full absolute left-[calc(50%-0px)] -top-60" />
      <div className="absolute flex  items-end justify-center gap-2 left-2 md:left-14">
        <a href="/" class="relative flex items-center">
          <div class="text-zinc-950 dark:text-white">motion Bees</div>
          <span class="mb-4 ml-2 select-none rounded-full border border-white/5 px-2 py-0.5 text-xs text-zinc-50">
            beta
          </span>
        </a>
      </div>

      <div className="absolute flex  items-end justify-center gap-2 right-2 md:right-14"></div>
    </header>
  );
};
